...
<?php
     $sql = "select * from blogs where blog_is_approved = 1";
     ...
     //  $unfilteredBlog2 = $row['blog_des'];
     //  $unfilteredBlog = htmlspecialchars_decode($row['blog_des']);
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <h5 class="card-title">'.substr($row['blog_title'],0,70).'</h5>
